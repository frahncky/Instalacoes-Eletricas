...
\centering\begin{tikzpicture}[scale=0.72,every node/.style={font=\tiny}]
...
\draw[-{Stealth},thick,corPrim](orig)--(qg);\foreach \x in {l,t,ac,el,sv}{\draw[-{Stealth},thick](qg)--(\x);}\draw[corNorma,thick](qg)--(bep);\draw[corNorma,thick](bep.south)--(4.4,2.1)node[ground]{};
\end{tikzpicture}
\end{frame}
