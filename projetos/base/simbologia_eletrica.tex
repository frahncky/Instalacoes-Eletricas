...
\column{0.50\textwidth}
\begin{align*}
I_b&=\frac{P_{in}}{V\,fp}=\frac{P_{out}}{V\,fp\,\eta}\quad (1\phi)\\
I_b&=\frac{P_{in}}{\sqrt3\,V_{LL}\,fp}=\frac{P_{out}}{\sqrt3\,V_{LL}\,fp\,\eta}\quad (3\phi)
\end{align*}
\begin{caixaEx}
Coordenação básica:
\[
...
\end{caixaEx}
\column{0.48\textwidth}
Para circuito resistivo simplificado, com $L$ de ida e $S$ como seção:
\[
...
\]
com $\rho=0{,}0225\,\Omega\,\mathrm{mm^2/m}$ como hipótese didática. Para cargas com $fp\neq1$, usar resistência e reatância na temperatura/condição de operação.
\end{columns}
\begin{caixaObs}
