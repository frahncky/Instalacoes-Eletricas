...
\begin{frame}{Industrial I — acessos e apoio refinados}\centering\begin{tikzpicture}[scale=0.205,every node/.style={font=\tiny}]\GalpaoFinalBase\end{tikzpicture}\vspace{0.2mm}\scriptsize A faixa frontal agora tem funções definidas e portas próprias: administração, refeitório, elétrica, manutenção, almoxarifado, vestiário e sanitários. Vãos logísticos são separados dos acessos de pedestres.\end{frame}
\begin{frame}{Industrial I — lançamento elétrico sobre a planta}\centering\begin{tikzpicture}[scale=0.205,every node/.style={font=\tiny}]\GalpaoFinalBase\SimQD{16}{3}{QGBT}\SimQD{18.5}{3}{CCM}\foreach \x in {3,8,13,18,23,28,33,38,43}{\SimLuz{\x}{10.5}\SimLuz{\x}{23.5}}\end{tikzpicture}\end{frame}
