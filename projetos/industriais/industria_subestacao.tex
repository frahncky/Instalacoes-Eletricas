...
\centering
\begin{tikzpicture}[scale=0.137,every node/.style={font=\tiny}]\IndustriaSEFinalBase\end{tikzpicture}
\vspace{0.2mm}\scriptsize Subestação e gerador possuem acessos externos restritos; a faixa técnica tem portas próprias; pedestres entram por portas dedicadas e as docas permanecem exclusivas ao fluxo logístico.
\end{frame}

\begin{frame}{Industrial II — distribuição física de força}
\centering
\begin{tikzpicture}[scale=0.137,every node/.style={font=\tiny}]
