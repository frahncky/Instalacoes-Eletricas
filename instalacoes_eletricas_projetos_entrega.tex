...
\begin{frame}[shrink=6]{Os seis projetos do caderno}
\scriptsize
\begin{tabularx}{\textwidth}{c p{3.0cm} p{3.1cm} X}
\toprule
ID & Projeto & Diferencial de arquitetura & Foco elétrico \\
\midrule
R1 & Casa térrea & 2 suítes, quarto 3, garagem, hall interno & entrada BT, balanceamento, dois chuveiros \\
R2 & Apartamento & 2 suítes, varanda, lavabo e serviço & unidade em EMUC, prumada e QD trifásico \\
C1 & Edifício corporativo & 3 pavimentos, 8 salas/tipo, WC M/F/PCD, elevador, escada & QGBT, elevador, SPDA, DPS \\
C2 & Clínica/serviços & recepção, 6 consultórios, procedimento, laboratório e esterilização & circuitos essenciais, UPS e locais médicos \\
