...
\node[anchor=west,corAccent!30!white,font=\fontsize{14}{17}\bfseries,text width=11.5cm,align=left] at ([xshift=2.55cm,yshift=-1.35cm]current page.west) {Seis projetos distintos — Equatorial Maranhão};
\end{tikzpicture}
\end{frame}
\end{document}
