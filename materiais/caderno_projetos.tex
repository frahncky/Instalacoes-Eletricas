%=====================================================================
% INSTALACOES ELETRICAS — SETE PROJETOS COMPLETOS
% 2 residenciais | 3 comerciais | 2 industriais
...
\newcommand{\TituloCurto}{7 Projetos}
\input{estilo/beamer_estilo_casa.tex}
\title{Instalações Elétricas — Sete Projetos Completos}
\subtitle{2 residenciais, 3 comerciais e 2 industriais — ABNT + Equatorial Maranhão}
...
\begin{caixaProjeto}[title=Sete arquiteturas diferentes]
\begin{itemize}
...
\item centro empresarial e de treinamento;
\item loja de shopping com projeto luminotécnico;
...
\end{columns}
\end{frame}
\input{projetos/projetos_completos.tex}
\begin{frame}[plain]
...
\node[anchor=west,white,font=\fontsize{31}{35}\bfseries,text width=11cm] at ([xshift=2.5cm,yshift=0.95cm]current page.west) {Fim do caderno de projetos};
\node[anchor=west,corAccent!30!white,font=\fontsize{14}{17}\bfseries,text width=11.5cm,align=left] at ([xshift=2.55cm,yshift=-1.35cm]current page.west) {Sete projetos distintos — Equatorial Maranhão};
\end{tikzpicture}
\end{frame}
\end{document}
