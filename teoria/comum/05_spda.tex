...
A edição 2026 da \textbf{Parte 1} está publicada e estabelece requisitos para a determinação da proteção contra descargas atmosféricas.
\end{caixaNorma}
\begin{itemize}
...
\begin{frame}{SPDA não é apenas o captor no telhado}
\small
\centering
