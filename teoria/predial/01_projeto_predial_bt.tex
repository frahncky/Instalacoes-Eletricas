...
\begin{frame}{TUG em habitações: banheiros e áreas de serviço}
\scriptsize
\begin{tabularx}{\textwidth}{>{\bfseries}p{3.0cm}p{4.45cm}X}
\toprule
...
\end{tabularx}
\begin{caixaAt}
Em cozinhas e áreas análogas, a contagem acompanha o perímetro e a potência de previsão depende da ordem dos pontos. Isso deve aparecer no memorial de cálculo.
\end{caixaAt}
\end{frame}

\begin{frame}{TUG em habitações: salas e demais ambientes}
\scriptsize
\begin{tabularx}{\textwidth}{>{\bfseries}p{3.0cm}p{4.45cm}X}
\toprule
Ambiente & Quantidade mínima & Potência atribuída \\
...
\begin{frame}[shrink=8]{Divisão de circuitos: critérios defensáveis}
\small
\begin{columns}[T,onlytextwidth]
\column{0.49\textwidth}
\begin{itemize}
