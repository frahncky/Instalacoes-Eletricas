...
\centering
\begin{tikzpicture}[scale=0.78,every node/.style={font=\scriptsize}]
\tikzset{b/.style={draw=corPrim,fill=corDef!7,rounded corners,minimum width=1.85cm,minimum height=0.62cm,align=center}}
\node[b] (r) at (0,2.6) {Rede};
\node[b] (g) at (0,0.8) {Gerador};
\node[b] (ats) at (2.2,1.7) {ATS};
\node[b] (ups) at (4.4,1.7) {UPS};
\node[b] (crit) at (6.6,1.7) {Cargas\\críticas};
