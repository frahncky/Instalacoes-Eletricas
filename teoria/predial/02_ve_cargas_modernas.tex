...
\[
19{,}88+7{,}40=\SI{27.28}{kW}.
\]
Logo, a inclusão do SAVE não é apenas ``mais um circuito'': exige reavaliar a carga instalada, o QD, o alimentador e o enquadramento da entrada perante a Equatorial.
\end{caixaProjeto}
\end{columns}
\end{frame}
