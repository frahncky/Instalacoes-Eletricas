...
\providecommand{\PRInt}[2]{\begin{scope}[shift={(#1,#2)}]\draw[corNorma,thick] (0,0) circle (0.11);\node[font=\tiny\bfseries,corNorma,anchor=west] at (0.14,0){S};\end{scope}}
...
\newcommand{\CasaResidencialBase}{%
  ...
  \draw[white,line width=5pt] (7.8,6.4)--(9.6,6.4);\draw[black!20,thin] (7.8,6.4)--(9.6,6.4);
...
\foreach \x/\y in {4.92/2.75,4.92/0.78,4.92/4.15,3.72/5.18,4.92/7.75,3.72/8.88,6.15/2.85,7.48/0.38,10.92/2.45,8.05/6.68,11.48/6.85,11.48/9.35}{\PRInt{\x}{\y}}
...
\end{tikzpicture}
\vspace{0.4mm}
\scriptsize Previsão calculada: C1 = 1,06 kVA e C2 = 1,40 kVA. Os círculos ``S'' marcam comandos junto aos acessos; os 2,46 kVA resultam das áreas e dos acréscimos completos de 4 m$^2$, não da quantidade de luminárias.
\end{frame}
...
\node[b](r)at(0,5.45){Rede EQTL\\380/220 V};
\node[b](m)at(0,4.25){Medição\\padrão de entrada};
\node[b](dg)at(0,3.05){DG 3P 63 A\\+ DPS coordenado};
\node[b,inner ysep=3pt](qd)at(0,1.85){QD1\\barras N e PE separadas};
\node[b,font=\tiny](g1)at(-4.35,0.45){C1--C8\\luz/TUG + RCBO};
\node[b,font=\tiny](g2)at(-1.45,0.45){C9--C11\\chuveiros + RCBO};
\node[b,font=\tiny](g3)at(1.45,0.45){C12--C13\\forno/lavadora};
\node[b,font=\tiny](g4)at(4.35,0.45){C14--C16\\ar-condicionado};
\node[b,draw=corNorma,fill=corNorma!7](bep)at(5.0,2.65){BEP\\PE + equipot.};
\draw[-{Stealth},thick,corPrim,shorten >=3pt](r.south)--(m.north);
\draw[-{Stealth},thick,corPrim,shorten >=3pt](m.south)--(dg.north);
\draw[-{Stealth},thick,corPrim,shorten >=3pt](dg.south)--(qd.north);
\foreach \x in {g1,g2,g3,g4}{\draw[-{Stealth},thick](qd)--(\x);}
\draw[corNorma,thick](qd)--(bep);
\draw[corNorma,thick](bep.south)--(5.0,1.70)node[ground]{};
\node[font=\tiny,corNorma,anchor=west] at (5.15,1.70){eletrodo(s)};
\end{tikzpicture}
\vspace{1mm}
