...
\begin{caixaNorma}[title=NR-10 publicada em 2026]
A nova redação prevê, quando aplicável, que o projeto considere \textbf{estudo de energia incidente} para definição de medidas de proteção contra efeitos térmicos do arco elétrico.
\end{caixaNorma}
\end{columns}
\end{frame}
