...
\column{.57\textwidth}
\centering
\begin{tikzpicture}[scale=.76,every node/.style={font=\scriptsize,align=center}]
...
\centering
\begin{tikzpicture}[scale=.84,every node/.style={font=\scriptsize,align=center}]
...
\column{.58\textwidth}
\centering
\begin{tikzpicture}[scale=.78,every node/.style={font=\scriptsize,align=center}]
