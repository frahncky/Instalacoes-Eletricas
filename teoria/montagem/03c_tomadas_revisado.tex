...
\column{.52\textwidth}
\centering
\begin{tikzpicture}[scale=.88,every node/.style={font=\scriptsize,align=center}]
...
\node[draw=corNorma,fill=corNorma!5,rounded corners,minimum width=2.1cm,minimum height=1.15cm](t1)at(-2.6,0){T1\\L \quad N \quad PE};
\node[draw=corNorma,fill=corNorma!5,rounded corners,minimum width=2.1cm,minimum height=1.15cm](t2)at(.6,0){T2\\L \quad N \quad PE};
\node[draw=corNorma,fill=corNorma!5,rounded corners,minimum width=2.1cm,minimum height=1.15cm](t3)at(3.8,0){T3\\L \quad N \quad PE};
